...
import com.example.notestaker.adapter.NoteAdapter
import com.example.notestaker.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuProvider {
    ...
    private fun updateUI(note: List<Note>?){
        ...
        if (note != null){
            if (note.isNotEmpty()){
                binding.emptyNotedImage.visibility = View.GONE
                binding.homeRecyclerView.visibility = View.VISIBLE

            } else {
                binding.emptyNotedImage.visibility = View.VISIBLE
